...
const  CartPage  = () => {
    ...
    const  calculateTotalPrice = useCallback( () => items.reduce((accum, item) => accum + item.totalPrice(),0),[items]);
    ...
    return (
        <div>
            ...
            <div className={classes.hk_cart_div_all_price}><p><span>Total</span>${allPrice}</p></div>
